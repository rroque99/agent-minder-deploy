...
require_env NAMESPACE HELM_REPO HELM_REPO_URL REGISTRY_SECRET_NAME
...
step "Image pull secret ${REGISTRY_SECRET_NAME}"
...
# The name must match REGISTRY_SECRET_NAME, which the templates reference.
...
ok "${REGISTRY_SECRET_NAME} present in ${NAMESPACE}"
